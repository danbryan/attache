...
struct CompanionSpeechConfiguration: Equatable {
    var provider: CompanionSpeechProvider
    ...
    static let systemDefault = CompanionSpeechConfiguration(
        provider: .system,
...
enum CompanionDevelopmentSecretStore {
    ...
    static var fileURL: URL {
        CompanionAppSupport.supportDirectory().appendingPathComponent(fileName)
    }
...
enum CompanionRemoteVoiceService {
    ...
    static func synthesize(text: String, configuration: CompanionSpeechConfiguration, outputURL: URL) async throws {
    ...
    private static func synthesizeOpenAI(text: String, configuration: CompanionSpeechConfiguration, outputURL: URL) async throws {
    ...
    private static func synthesizeElevenLabs(text: String, configuration: CompanionSpeechConfiguration, outputURL: URL) async throws {
    ...
    private static func synthesizeXAI(text: String, configuration: CompanionSpeechConfiguration, outputURL: URL) async throws {
