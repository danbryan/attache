...
final class AttacheSessionReaderTests: XCTestCase {
    func testParsesUserAndAssistantTurnsInOrder() {
        ...
        let turns = AttacheSessionReader.parseTurns(fromJSONL: jsonl)
    ...
    func testReadFileReadsRelativePathInsideRoot() throws {
        ...
        XCTAssertEqual(
            AttacheSessionReader.readFile(path: "docs/notes.txt", within: root.path),
            "hello from inside"
        )
    }
    ...
    func testReadFileWorksWhenRootIsUnderSymlinkedTmp() throws {
        ...
        XCTAssertEqual(
            AttacheSessionReader.readFile(path: "notes.txt", within: root.path),
            "tmp root works"
        )
    }
    ...
    func testReadFileRefusesSymlinkEscape() throws {
        ...
        XCTAssertNil(AttacheSessionReader.readFile(path: "link/secret.txt", within: root.path))
    }
    ...
    func testReadFileRefusesSymlinkedIntermediateDirEscape() throws {
        ...
        XCTAssertNil(AttacheSessionReader.readFile(path: "sub/link/../escape.txt", within: root.path))
    }
    ...
    func testReadFileRefusesHomeSymlinkEscape() throws {
        ...
        XCTAssertNil(AttacheSessionReader.readFile(path: "homelink/.ssh/config", within: root.path))
    }
    ...
    func testReadFileRefusesAbsolutePathOutsideRoot() throws {
        ...
        XCTAssertNil(AttacheSessionReader.readFile(path: "/etc/hosts", within: root.path))
    }
    ...
    func testReadFileRefusesParentTraversal() throws {
        ...
        XCTAssertNil(AttacheSessionReader.readFile(path: "../sibling.txt", within: root.path))
    }
    ...
    func testReadFileRefusesSiblingWithSharedPrefix() throws {
        ...
        XCTAssertNil(AttacheSessionReader.readFile(path: file.path, within: root.path))
    }
    ...
    func testReadFileRefusesOversizedFile() throws {
        ...
        XCTAssertNil(AttacheSessionReader.readFile(path: "big.txt", within: root.path))
    }
}
