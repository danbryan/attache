...
final class AttacheSessionTranscriptTests: XCTestCase {
    ...
    func testSmallSessionRendersAllTurnsWithIndices() throws {
        ...
        let text = AttacheSessionReader.transcript(fromFileURL: url)
    ...
    func testTranscriptPageReturnsRequestedTurnsWithIndices() throws {
        ...
        let page = AttacheSessionReader.transcriptPage(fromFileURL: url, startTurn: 41, maxChars: 200)
    ...
    func testTranscriptPageBeyondEndExplains() throws {
        ...
        defer { try? FileManager.default.removeItem(at: url) }
        let page = AttacheSessionReader.transcriptPage(fromFileURL: url, startTurn: 99)
        XCTAssertNotNil(page)
    ...
    func testSearchFindsMatchingTurnByNumber() throws {
        ...
        let result = AttacheSessionReader.searchTranscript(fromFileURL: url, query: "DISTINCTIVE_TOKEN")
    ...
    func testSearchNoMatchGuidance() throws {
        ...
        defer { try? FileManager.default.removeItem(at: url) }
        let result = AttacheSessionReader.searchTranscript(fromFileURL: url, query: "absent")
        XCTAssertNotNil(result)
